...
from neuroir.eval.squad_eval import metric_max_over_ground_truths, f1_score, exact_match_score
...
def train(args, data_loader, model, global_stats):
    ...
    for idx, ex in enumerate(pbar):
        ...
        log_info = 'Epoch = %d [ml_loss = %.2f]' % (global_stats['epoch'], ml_loss.avg)
...
def eval_accuracies(hypotheses, references, copy_info, sources=None,
                    filename=None, print_copy_info=False, print_one_target=True):
    ...
    for key in references.keys():
        ...
        if fw:
            ...
            logobj['references'] = references[key][0] if print_one_target \
                else references[key]
...
def main(args):
    ...
    if not args.only_test:
        ...
        for epoch in range(start_epoch, args.num_epochs):
            ...
            # Save best valid
            model.save(args.model_file)#Hossein: Might be no best model
