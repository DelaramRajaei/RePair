...
settings = {
    'cmd': [],  # steps of pipeline, ['query_refinement', 'similarity', 'search', 'rag_fusion', 'eval', 'agg', 'build', 'box','dense_retrieve', 'stats]
    'datalist': ['./../data/raw/clueweb09b'], # ['./../data/raw/robust04', './../data/raw/gov2', './../data/raw/antique', './../data/raw/dbpedia', './../data/raw/clueweb09b']
    'domainlist': ['clueweb09b'], # ['robust04', 'gov2', 'antique', 'dbpedia', 'clueweb09b']
